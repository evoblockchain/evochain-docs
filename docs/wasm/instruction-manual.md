# EVO wasm instruction manual
This manual will mainly discuss how to use CLI commands on EVO for all actions regarding wasm smart contracts.
...
# If you are building your own node, please refer to the following commands
# evochaincli config node <host>:<port>
evochaincli config node https://evochaintesttmrpc.evoblock.com
```
#### Local testnet
Download the EVO source code and set up the EVO local testnet through the script we provide.
...
sh start.sh
```
With start.sh, there is no need to configure `evochaincli`
...
Use the standard IDE and Rust plugin for developing EVO wasm contracts
...
```Bash
# upload the wasm code to EVO and you will get a code id.

evochaincli tx wasm store ./cw-plus/target/wasm32-unknown-unknown/release/cw20_base.wasm --from captain --fees 0.001evo --gas 3000000 -b block -y
```
...
```Bash
{
  ...
  "data": "0802",
  "raw_log": "[{\"msg_index\":0,\"log\":\"\",\"events\":[{\"type\":\"message\",\"attributes\":[{\"key\":\"action\",\"value\":\"store-code\"},{\"key\":\"module\",\"value\":\"wasm\"},{\"key\":\"sender\",\"value\":\"evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v\"}]},{\"type\":\"store_code\",\"attributes\":[{\"key\":\"code_id\",\"value\":\"2\"}]}]}]",
  "logs": [
    {
      "msg_index": 0,
      "log": "",
      "events": [
        {
          ...
          "attributes": [
            ...
            {
              "key": "sender",
              "value": "evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v"
            }
          ]
        },
        {
...
# e.g.
#    code_id=1
#    instantiate_message='{"decimals":10,"initial_balances":[{"address":"evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v","amount":"100000000"}],"name":"my test token", "symbol":"mtt"}'
#    --label=test (label can be any human readable string)
#    --admin=evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v (usually same as from)
#    --from=evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v
#    --fees=0.001evo
#    --gas=3000000

evochaincli tx wasm instantiate 1 '{"decimals":10,"initial_balances":[{"address":"evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v","amount":"100000000"}],"name":"my test token", "symbol":"mtt"}' --label test --admin evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v --from evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v --fees 0.001evo --gas 3000000 -b block -y
```
...
```JSON
{"decimals":10,"initial_balances":[{"address":"evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v","amount":"100000000"}],"name":"my test token", "symbol":"mtt"}
``` 

The contract address is `evo14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9s6fqu27` in transaction receipt.
```JSON

{
  ...
  "raw_log": "[{\"msg_index\":0,\"log\":\"\",\"events\":[{\"type\":\"instantiate\",\"attributes\":[{\"key\":\"_contract_address\",\"value\":\"evo14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9s6fqu27\"},{\"key\":\"code_id\",\"value\":\"1\"}]},{\"type\":\"message\",\"attributes\":[{\"key\":\"action\",\"value\":\"instantiate\"},{\"key\":\"module\",\"value\":\"wasm\"},{\"key\":\"sender\",\"value\":\"evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v\"}]}]}]",
  "logs": [
    {
      "msg_index": 0,
      "log": "",
          ...
          "attributes": [
            {
              ...
              "value": "evo14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9s6fqu27"
            },
            {
              "key": "code_id",
              "value": "1"
...
# e.g.
#    contract_address=evo1eyfccmjm6732k7wp4p6gdjwhxjwsvje44j0hfx8nkgrm8fs7vqfsfxfyxv
#    execute_message='{"transfer":{"amount":"100","recipient":"evo190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0"}}'
#    --admin=evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v (usually same as from)
#    --from=evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v
#    --fees=0.001evo
#    --gas=3000000

evochaincli tx wasm execute evo14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9s6fqu27 '{"transfer":{"amount":"100","recipient":"evo190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0"}}' --from captain --fees 0.001evo --gas 3000000 -b block -y
```
...
```JSON
{"transfer":{"amount":"100","recipient":"evo190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0"}}
```
It means send 100 cw20 token to `evo190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0` address.
...
#    contract_address=evo14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9s6fqu27
#    query_message='{"balance":{"address":"evo190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0"}}'

evochaincli query wasm contract-state smart evo14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9s6fqu27 '{"balance":{"address":"evo190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0"}}'
```
...
```str
'{"balance":{"address":"evo190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0"}}'
```
The cw20 balance of `evo190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0` is expected to be 100 since we transferred 100 cw20 token to evo190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0. And the query response will be:
...
# e.g.
#    <contractAddr>=evo1eyfccmjm6732k7wp4p6gdjwhxjwsvje44j0hfx8nkgrm8fs7vqfsfxfyxv
#    <new_code_id>=2
#    <instantiate_message>="" (refer to the schema file of the new code)
#    <from_address_or_name>=evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v
#    <fees>=0.01evo
#    <gas>=3000000

evochaincli tx wasm migrate <contractAddr> <new_code_id> <instantiate_message> --from <from_address_or_name> --fees <fees> --gas <gas> -b block -y
```
...
```Bash
evochaincli tx wasm store <path_to_wasm_file> --instantiate-everybody=true --from <from_address_or_name> --fees <fees> --gas <gas> -b block -y
```
2. A specific address can initialize the contract with this code. For example, only `evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3vcan` can initialize
```Bash
evochaincli tx wasm store <path_to_wasm_file> --instantiate-only-address=evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v --from <from_address_or_name> --fees <fees> --gas <gas> -b block -y
```
3. No one can use this code to initialize contracts
```Bash
evochaincli tx wasm store <path_to_wasm_file> --instantiate-nobody=true --from <from_address_or_name> --fees <fees> --gas <gas> -b block -y
```
...
# e.g.
#    <contractAddr>=evo1eyfccmjm6732k7wp4p6gdjwhxjwsvje44j0hfx8nkgrm8fs7vqfsfxfyxv
#    <new_admin_address>=evo190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0
#    <admin_address>=evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v
#    <fees>=0.01evo
#    <gas>=3000000

evochaincli tx wasm set-contract-admin <contractAddr> <new_admin_address> --from <admin_address> --fees <fees> --gas <gas> -b block -y
```
...
evochaincli tx wasm clear-contract-admin <contractAddr> --from <admin_address> --fees <fees> --gas <gas> -b block -y
```
In addition, EVO also provides a proposal function, and validators can upgrade contracts and clear the admin account of a specific contract through proposals and voting.
...
evochaincli tx wasm store <path_to_wasm_file> --from <from_address_or_name> --fees <fees> --gas <gas> -b block -y
```
...
#    <instantiate_message>
#    <label>=test (label can be any human readable string)
#    <admin_address>=evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v (usually same as <from_address_or_name>)
#    <from_address_or_name>=evo1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v
#    <fees>=0.01evo
#    <gas>=3000000

evochaincli tx wasm instantiate <code_id> <instantiate_message> --label <label> --admin <admin_address> --from <from_address_or_name> --fees <fees> --gas <gas> -b block -y
```
...
evochaincli tx wasm execute <contract_address> <execute_message> --from <from_address_or_name> --fees <fees> --gas <gas> -b block -y
```
...
```Bash
evochaincli query wasm list-code
```
...
evochaincli query wasm list-contract-by-code <code_id>
```
...
evochaincli query wasm code <code_id> <filename>
```
...
evochaincli query wasm code-info <code_info>
```
...
evochaincli query wasm contract <contract_address>
```
...
evochaincli query wasm contract-history <contract_address>
```
...
evochaincli query wasm contract-state all <contract_address>
```
...
evochaincli query wasm contract-state smart <contract_address> <query_message>
```
#### 8. List all pinned codes
```Bash
evochaincli query wasm pinned
```
#### 9. Query version number of wasmvm
```Bash
  evochaincli query wasm libwasmvm-version
```
