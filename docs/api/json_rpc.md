...
JSON-RPC methods and namespaces supported on EVO. 

mainnet:https://evochainrpc.evoblock.com/

testnet:https://evochaintestrpc.evoblock.com/

```shell
# mainnet
curl -X POST --data '{"jsonrpc":"2.0","method":"eth_blockNumber","params":[],"id":1}' -H "Content-Type: application/json" https://evochainrpc.evoblock.com/


# testnet
curl -X POST --data '{"jsonrpc":"2.0","method":"eth_blockNumber","params":[],"id":1}' -H "Content-Type: application/json" https://evochaintestrpc.evoblock.com/
```
...
| Method                                                                            | Namespace | If supported by EVO | Notes        |
|-----------------------------------------------------------------------------------|-----------|-------------|---------------------------|
...
Returns the current gas price in EVO.
