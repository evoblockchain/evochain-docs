...
- Click the “confirm” button to sign and broadcast the transaction to EVO.
...
- Click the “Deploy” button and Metamask will pop up
- Click the “confirm” button to sign and broadcast transaction to EVO.
## Verify Proxy Contract on EVOBlock
