...
### The smart contract
- Create new contract KIP20Tokens.sol and copy contract code from the KIP20 token template [here](https://github.com/evoblockchain/KIPs/blob/master/docs/final/KIP-20.md/)
...
Now, We have to deploy our smart contract on EVO Network. For that, we have to connect to web3 world, this can be done my many services like Metamask, Brave, Portis etc. We will be using Metamask. Please follow this [tutorial to setup a Metamask Account]().
...
- Head over to [Faucet](https://discord.gg/B5nMs6qK5F) and request test EVO
- Now, let's Deploy the Smart Contract on EVO Testnet
...
Congratulations! You have successfully deployed a KIP20 Contract. Now you can interact with the Smart Contract. Check the deployment status here: https://www.evoblock.com/evo-test
