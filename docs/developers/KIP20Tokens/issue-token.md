...
1.Create new contract KIP20Token.sol and copy contract code from the KIP20 token template [here](https://github.com/evoblockchain/KIPs/blob/master/docs/final)
...
e. Client “confirm” button to sign and broadcast transaction to EVO.
