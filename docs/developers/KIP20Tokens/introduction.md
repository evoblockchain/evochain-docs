...
```
Then users can use [Remix IDE](https://remix.ethereum.org/) and Metamask to compile and deploy the KIP20 contract to EVO.
## Interact with Contract with [Web3](https://www.npmjs.com/package/web3) and NodeJS.

Connect to EVO's public RPC endpoint
```
...
```
Output:
The balance will be bumped by e18 for EVO.
```
6249621999900000000
```
Create transaction
