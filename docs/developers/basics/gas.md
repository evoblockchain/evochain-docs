...
More information regarding gas in Cosmos SDK can be found [here](https://docs.cosmos.network/master/basics/gas-fees.md).
...
The Cosmos SDK [`AnteHandler`](https://docs.cosmos.network/master/basics/gas-fees.md#antehandler)
