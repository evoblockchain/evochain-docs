...
Note: After registering as a new validator, the commission rate is defaulted at 1. The validator can set their preferred rate by initiating a transaction; for a more detailed explanation, refer to [EVO CLI staking manual](../../delegators/delegators-staking-cli.md).
